...
def get_main_menu_keyboard():
    keyboard = [
        ...
        [KeyboardButton("🎓 Kurs ishi / BMI 📝"),    KeyboardButton("📰 Maqola ✨")],
        [KeyboardButton("📜 Tezis ✨"),         KeyboardButton("📚 Referat ✨")],
        [KeyboardButton("🧩 Krossvord ✨"),     KeyboardButton("💡 Glossary ✨")],
        [KeyboardButton("✍️ Insho / Esse ✨"),    KeyboardButton("🔠 Test tuzish")],
        [KeyboardButton("📜 Motivatsion xat ✨"),    KeyboardButton("📄 Rezyume / CV ✨")],
        [KeyboardButton("🗺️ Kontsept xarita ✨"),    KeyboardButton("📊 Jadval & Diagramma ✨")],
        [KeyboardButton("📝 Taqriz ✨"),  KeyboardButton("📋 Annotatsiya ✨")],
        [KeyboardButton("📦 Ziplash/Arxivlash 🗄️"),  KeyboardButton("📊 Infografika ✨")],
        [KeyboardButton("📄 PDF Konvertatsiya 🔄"),  KeyboardButton("🤖 AI yordamchi 💬")],
...
async def ob_tugilgan_yili_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        f"_Masalan: Toshkent viloyati, Bo'ka tumani_",
        parse_mode="MarkdownV2"
    )
